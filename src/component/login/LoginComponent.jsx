...
function LoginComponent() {
  ...
  const handleSuccessModalClose = () => {
    setShowSuccessModal(false);
    navigate("/");
    handleIconClick("home"); // Chiama la funzione di callback
  };

  const handleIconClick = (iconName) => {
    // Logica per selezionare l'icona nella navbar
    console.log(`Icona "${iconName}" selezionata`);
  };
  ...
  return (
    <>
      ...
      <NavbarComponent onIconClick={handleIconClick} />
    </>
  );
}
